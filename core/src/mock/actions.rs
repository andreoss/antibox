...
impl DisplayBackend for MockDisplay {
    fn open(_name: Option<&str>) -> Result<Self, Box<dyn Error>> {
    ...
    fn query_extension(&self, _name: &str) -> Result<bool, Box<dyn Error>> {
        Ok(false)
    }
    ...
    fn ungrab_keyboard(&self, _time: u32) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
    fn query_pointer(&self, _window: u32) -> Result<PointerState, Box<dyn Error>> {
        Ok(PointerState {
            root_x: 0,
            root_y: 0,
            mask: KeyButMask(0),
    ...
    fn kill_client(&self, _resource: u32) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
    fn configure_window(&self, _window: u32, _value_list: &[u32]) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
    ...
    fn clear_area(&self, _exposures: bool, _window: u32, _area: Rect) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
    ...
    fn get_selection_owner(&self, _selection: u32) -> Result<u32, Box<dyn Error>> {
        Ok(0)
    }
    fn reparent_window(&self, _child: u32, _parent: u32, _pos: Point) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
    ...
    fn query_tree(&self, _window: u32) -> Result<QueryTreeResult, Box<dyn Error>> {
        Ok(QueryTreeResult {
    ...
    fn get_window_attributes(&self, _window: u32) -> Result<WindowAttributes, Box<dyn Error>> {
        Ok(WindowAttributes {
    ...
    fn restack_windows(&self, _windows: &[u32]) -> Result<(), Box<dyn Error>> {
        Ok(())
    }
